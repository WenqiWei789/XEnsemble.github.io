...
\usepackage{cleveref}
\usepackage{indentfirst}  % indent the first paragraph after a sectional heading
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
{\bf \noindent Homework 2. DP \\ Due: Thursday, September 19, 2019 before 3pm EDT.}
...
\begin{problem}{Longest Common Sub*!?*}
